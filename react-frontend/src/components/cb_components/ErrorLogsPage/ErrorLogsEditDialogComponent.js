...
details: _entity?.details,
    ...
    return (
        <Dialog header="Edit Error Logs" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
