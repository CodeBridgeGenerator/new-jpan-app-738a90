...
<Column field="tajukLatihan" header="TajukLatihan" body={pTemplate1} filter={selectedFilterFields.includes("tajukLatihan")} hidden={selectedHideFields?.includes("tajukLatihan")}  sortable style={{ minWidth: "8rem" }} />
