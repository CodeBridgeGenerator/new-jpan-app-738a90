...
import JobQuesPage from "../cb_components/JobQuesPage/JobQuesPage";
...
import ErrorLogsPage from "../cb_components/ErrorLogsPage/ErrorLogsPage";
...
const ProjectLayout = (props) => {
  ...
  const renderChild = (page) => {
    switch (page) {
      ...
      case "messaging":
        return <Messaging />;
      case "documentStorages":
        return <DocumentStoragesPage />;
      case "errorLogs":
