...
const DokumenPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("dokumen")
            .find({ query: { $limit: 10000 , tajukLatihan : urlParams.singleLatihanId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="dokumen-add-button"/>
